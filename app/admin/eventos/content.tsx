...
import { IEvents, IPlan } from "@/app/types/api";
    ...
    <>
      <SafeAreaContainer isTable>
        <MainContainer>
          ...
          {loading ? (
            <div className="w-full h-10 animate-pulse bg-gray-100 rounded-md duration-500"></div>
          ) : (
      ...
      <div>
        ...
        >
          ...
          >
            ...
            >
              {selectedType === "create" ? "Crear" : "Editar"} Evento
            </Typography>
            <EventForm
